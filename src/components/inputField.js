...
export default class InputField extends Component {
    render() {
        let { type, label, placeholder, name, value, onChange, options } = this.props
        switch (type) {
            case "date":
                return (
                    <Form.Group>
            ...
            case "sign":
                return (
                    <Form.Group>
                        <Form.Label><p className="primary_paragraph">{label}*</p></Form.Label>
                        <div><SignatureCanvas canvasProps={{className: 'SignCanvas'}}/></div>
                    </Form.Group>
                )
            default: return (
                <Form.Group>
                    <Form.Label><p className="primary_paragraph">{label}*</p></Form.Label>
                    <Form.Control onChange={onChange} name={name} required value={value} placeholder={placeholder} />
                </Form.Group>
            )
        }
