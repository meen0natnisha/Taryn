    ...
    render() {
        ...
        const renderStudentField = () => {
            return (
                <>
                    <Form>
                        <Row><Col><InputField label='ตำแหน่ง' placeholder='นักเรียน' value={profile?.role_id} disabled={true} /></Col></Row>
                        ...
                        <Row>
                            ...
                            <Col xs={6}><InputField label='หมู่' placeholder='กรอกหมู่' value={'-'}/></Col>
                        </Row>
                        <Row><Col><InputField label='ถนน' placeholder='ถนน' value={'-'} disabled={true} /></Col></Row>
